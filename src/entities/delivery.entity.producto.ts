...
export class Producto {
  ...
  nombre: string; // Ej: "Empanada de Pollo", "Coca-Cola Zero", "Empanada Árabe"

  @Column({ type: 'text', nullable: true })
  descripcion: string | null; // Acepta string o null

  @Column({ type: 'int' }) // Columna para el ID de la categoría, gestionada manualmente
  categoriaId: number;
  ...
  stock: number; // Cantidad de unidades en stock. Por defecto 0.
}
